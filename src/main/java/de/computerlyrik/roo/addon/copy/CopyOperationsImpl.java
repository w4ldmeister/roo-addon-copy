...
@Service
public class CopyOperationsImpl implements CopyOperations {
    ...
    /** {@inheritDoc} */
    public void annotateType(JavaType javaType, Set<String> excludeFields) {
        ...
        if (existing != null && MemberFindingUtils.getAnnotationOfType(existing.getAnnotations(), new JavaType(RooCopy.class.getName())) == null) {
            ...
            JavaType rooRooCopy = new JavaType(RooCopy.class.getName());

            // Create Annotation metadata
            AnnotationMetadataBuilder annotationBuilder = new AnnotationMetadataBuilder(rooRooCopy);
